...
function hackeryou_scripts() {
  ...
  wp_enqueue_script(
    'scripts', //handle
    get_template_directory_uri() . '/js/jquery.flexslider.js', //source
    array( 'jquery', 'plugins' ), //dependencies
    null, // version number
    true //load in footer
  );
...
function my_theme_scripts() {
    wp_enqueue_script( 'jquery.flexslider', get_template_directory_uri() . '/js/jquery.flexslider.js', array( 'jquery' ), '1.0.0', true );
}
